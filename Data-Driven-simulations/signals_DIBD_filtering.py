...
with open("../results_mixed/simulation_DIBD_amnon_mixed_fl_s15.pkl", "wb") as f:
    pickle.dump((filtlev, B, c, nSample, num_nulls, FDR_bh1, FDR_fbh1, FDR_ds1, PWR_bh1, PWR_fbh1, PWR_ds1,
