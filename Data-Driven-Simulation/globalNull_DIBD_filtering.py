...
with open("../results_filtering/simulation_dibd_norm_s20_filterSum_B100k.pkl", "wb") as f:
    pickle.dump((filtlev, B, nSample, num_nulls, p_bh, p_fbh, p_ds, err_bh, err_fbh, err_ds), f)   
