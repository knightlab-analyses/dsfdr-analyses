...
same_sorted = filtering(same_sorted, filterLev=filtlev)
...
with open("../results_mixed/simulation_DIBD_amnon_mixed_s_fl10_10k.pkl", "wb") as f:
    pickle.dump((filtlev, B, c, sample_range, FDR_bh1, FDR_fbh1, FDR_ds1, PWR_bh1, PWR_fbh1, PWR_ds1,
        OTU_bh1, OTU_fbh1, OTU_ds1, err_bh1, err_fbh1, err_ds1), f)
